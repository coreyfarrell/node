...
const CAN_FETCH = new Set(['module', 'json', 'wasm']);
...
class Loader {
  ...
  async resolve(specifier, parentURL) {
    ...
    const { url, format, fetchSource } = resolved;
    ...
    } else if (typeof fetchSource !== 'undefined')
      throw new ERR_INVALID_RETURN_PROPERTY_VALUE(
        'function', 'loader resolve', 'fetchSource', fetchSource
      );
